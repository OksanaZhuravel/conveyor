    ...
    <section className="m-auto mt-30 flex max-w-[1780px] items-center justify-start gap-15">
      ...
      <div className="relative flex max-w-[730px] flex-col items-start gap-5">
        ...
        <p className="text-2xl font-normal">
          ...
          и сложности. Мы предоставляем прозрачные тарифы и выгодные условия
          сотрудничества.
        </p>
        <p className="text-2xl font-normal">
          Наша биржа — это место встречи тех, кто заказывает заявки, и тех,
          кто их предоставляет. Мы создаём условия для успешного сотрудничества
          и взаимной выгоды.
        </p>
        {isExpanded && (
          <>
