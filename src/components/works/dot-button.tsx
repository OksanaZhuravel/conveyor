...
export const DotButton = ({ isActive, children, ...rest }: ComponentProps) => {
  ...
  return (
    <button
      ...
      {...rest}
      className={cn(
        'bg-secondary m-0 flex h-7.5 w-7.5 cursor-pointer items-center justify-center rounded-full border-none p-0 transition-colors duration-500 after:flex after:h-full after:w-full after:items-center after:rounded-full after:border after:border-transparent after:p-2 after:transition-colors after:duration-500 after:content-[""]',
        {
